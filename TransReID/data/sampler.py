...
def build_train_sampler(
    ...
    **kwargs
    ...
    if train_sampler == 'RandomIdentitySampler':
        # sampler = RandomIdentitySampler(data_source, batch_size, num_instances) # original
############################################################################### zwq 
        if dist_train:
            print('DIST_TRAIN START')
            mini_batch_size = batch_size // dist.get_world_size()
            data_sampler = RandomIdentitySampler_DDP(data_source, batch_size, num_instances)
            sampler = torch.utils.data.sampler.BatchSampler(data_sampler, mini_batch_size, True)
        else:
