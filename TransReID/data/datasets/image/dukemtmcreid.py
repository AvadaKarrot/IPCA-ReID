...
class DukeMTMCreID(ImageDataset):
    ...
    def __init__(self, root='', **kwargs):
        ...
        self.train_dir = osp.join(
            self.dataset_dir, 'DukeMTMC-reID/dukemtmc/bounding_box_train'
        )
        self.query_dir = osp.join(self.dataset_dir, 'DukeMTMC-reID/dukemtmc/query')
        self.gallery_dir = osp.join(
            self.dataset_dir, 'DukeMTMC-reID/dukemtmc/bounding_box_test'
        )
