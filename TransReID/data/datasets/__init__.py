...
from data.datasets.image import (
    GRID, PRID, CUHK01, CUHK02, CUHK03, MSMT17, CUHKSYSU, VIPeR, SenseReID,
    Market1501, DukeMTMCreID, University1652, iLIDS
)
from data.datasets.video import PRID2011, Mars, DukeMTMCVidReID, iLIDSVID
from data.datasets.dataset import Dataset, ImageDataset, VideoDataset
