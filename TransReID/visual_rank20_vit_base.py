...
from model import make_model_debug
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config_file", default="configs/visual/vit_base.yml", help="path to config file", type=str
    )
    ...
    model = make_model_debug(cfg, num_class=data_manager._num_train_pids, camera_num=data_manager._num_train_cams)
